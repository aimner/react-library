...
import classes from './terms-section.module.scss';
  ...
  return (
    <section>
      <div className={classes.terms_block}>
        <h2 className={classes.terms_block__title}>
          {splitLocation.at(-1) === 'terms' ? 'Правила пользования' : 'Договор оферты'}
        </h2>
        <ul>
          <li>
            ...
            <ul>
              ...
              <li className={classes.terms_block__lastItem}>
